...
import { MarketBandChart, palette } from "@/components/charts/Chart";
...
export default function Page() {
  ...
  // Y domain: include start value with padding
  const yMin = Math.min(...data.map((d) => d.low), startValueM) * 0.95;
  const yMax = Math.max(...data.map((d) => d.high), startValueM) * 1.05;
        ...
        <div className="md:col-span-2 space-y-6">
          ...
          <div className="border border-rule rounded-md p-4 bg-paper">
            ...
            <MarketBandChart
              ...
              bandLabel="±1.6σ band"
              centerColor={palette.primary}
              bandColor={palette.gold}
